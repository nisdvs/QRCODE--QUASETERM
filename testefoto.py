...
mGui.state('zoomed')
camFrame = Frame(mGui, width=370, height=370)
camFrame.place(x=100, y=250) #TROCAR LOCAL DO BLOCO
camFrame.config(borderwidth=2, relief="solid")
infoFrame = Frame(mGui, width=370, height=370, bg='#EEE8E8')
infoFrame.place(x=795, y=250) #TROCAR LOCAL DO BLOCO
...
def dddd():
            ...
            try:
                ...
                if nome_aluno in alunos_dict.keys() and today in dias_almoco and dias_almoco == alunos_dict[nome_aluno]:
                    ...
                    if not aluno_presente:
                        ...
                        label_foto_aluno.place(x=795, y=250)  
    ...
    image_label.place(x=555, y=450 - image_height)  
